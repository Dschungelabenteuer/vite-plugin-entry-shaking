export { default as DefaultImportJSX } from '@test-modules/default-export-unnamed-jsx';
export { default as DefaultImportJSXDupe } from '@test-modules/default-export-unnamed-jsx';
