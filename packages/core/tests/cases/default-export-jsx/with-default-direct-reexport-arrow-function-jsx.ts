export { default as DefaultImportJSX } from '@test-modules/default-export-arrow-function-jsx';
export { default as DefaultImportJSXDupe } from '@test-modules/default-export-arrow-function-jsx';
