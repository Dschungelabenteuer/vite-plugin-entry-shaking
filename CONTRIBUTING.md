...
JavaScript runtime and [pnpm](https://pnpm.io/installation) as a package manager. Please make
...
1. Running oxfmt to format code: `pnpm format`
2. Running oxlint to lint code: `pnpm lint`
